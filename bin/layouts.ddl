...
WITH LOCALITY GROUP default
  ...
  FAMILY info WITH DESCRIPTION 'basic information' (
    ...
    address "string" WITH DESCRIPTION 'Street address'
  ),
...
CREATE TABLE users WITH DESCRIPTION 'A collection of users.'
ROW KEY FORMAT HASH PREFIXED(2)
WITH LOCALITY GROUP default
  WITH DESCRIPTION 'Main locality group' (
  MAXVERSIONS = 10,
...
CREATE TABLE third WITH DESCRIPTION 'A collection of users.'
ROW KEY FORMAT HASH PREFIXED(2)
WITH LOCALITY GROUP default
  WITH DESCRIPTION 'Main locality group' (
  MAXVERSIONS = 10,
